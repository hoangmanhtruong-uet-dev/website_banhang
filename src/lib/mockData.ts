...
export const mockProducts: Product[] = [
  {
    id: '1', name: 'Áo Khoác Denim Premium', price: '1290000.0000', currency: 'VND', originalPrice: '1890000.0000',
  ...
  {
    id: '2', name: 'Tai Nghe Bluetooth Pro', price: '2490000.0000', currency: 'VND', originalPrice: '3290000.0000',
  ...
  {
    id: '3', name: 'Serum Vitamin C 20%', price: '450000.0000', currency: 'VND', originalPrice: '650000.0000',
  ...
  {
    id: '4', name: 'Bàn Làm Việc Gỗ Sồi', price: '4590000.0000', currency: 'VND',
  ...
  {
    id: '5', name: 'Giày Sneaker Urban', price: '1890000.0000', currency: 'VND', originalPrice: '2490000.0000',
  ...
  {
    id: '6', name: 'Laptop Gaming RTX 4060', price: '25990000.0000', currency: 'VND', originalPrice: '29990000.0000',
  ...
  {
    id: '7', name: 'Nước Hoa Unisex EDP', price: '1650000.0000', currency: 'VND',
  ...
  {
    id: '8', name: 'Đèn Bàn LED Thông Minh', price: '890000.0000', currency: 'VND',
  ...
  {
    id: '9', name: 'Đồng Hồ Thông Minh V5', price: '3290000.0000', currency: 'VND', originalPrice: '4190000.0000',
  ...
  {
    id: '10', name: 'Áo Thun Cotton Organic', price: '390000.0000', currency: 'VND',
  ...
  {
    id: '11', name: 'Máy Pha Cà Phê Espresso', price: '6890000.0000', currency: 'VND',
  ...
  {
    id: '12', name: 'Balo Du Lịch Chống Nước', price: '790000.0000', currency: 'VND', originalPrice: '1190000.0000',
...
export const mockOrders: Order[] = [
  {
    ...
    total: '3780000.0000', currency: 'VND', status: 'delivered', paymentStatus: 'paid', customerName: 'Nguyễn Văn An', customerEmail: 'an.nguyen@email.com',
    customerPhone: '0901234567', shippingAddress: '123 Nguyễn Huệ, Q.1, TP.HCM', shippingFee: '30000.0000',
    paymentMethod: 'COD', createdAt: '2026-05-10T08:30:00Z',
  },
  {
    id: 'ORD-002', items: [{ product: mockProducts[5], quantity: 1 }],
    total: '25990000.0000', currency: 'VND', status: 'processing', paymentStatus: 'paid', customerName: 'Trần Thị Bình', customerEmail: 'binh.tran@email.com',
    customerPhone: '0912345678', shippingAddress: '456 Lê Lợi, Q.3, TP.HCM', shippingFee: '0.0000',
  ...
  },
  {
    ...
    total: '2550000.0000', currency: 'VND', status: 'shipped', paymentStatus: 'paid', customerName: 'Lê Minh Cường', customerEmail: 'cuong.le@email.com',
    customerPhone: '0923456789', shippingAddress: '789 Trần Hưng Đạo, Hoàn Kiếm, Hà Nội', shippingFee: '40000.0000',
    paymentMethod: 'MoMo', createdAt: '2026-05-12T09:15:00Z',
  },
  {
    id: 'ORD-004', items: [{ product: mockProducts[8], quantity: 1 }],
    total: '3290000.0000', currency: 'VND', status: 'pending', paymentStatus: 'unpaid', customerName: 'Phạm Thu Dung', customerEmail: 'dung.pham@email.com',
    customerPhone: '0934567890', shippingAddress: '321 Hai Bà Trưng, Q.1, TP.HCM', shippingFee: '30000.0000',
